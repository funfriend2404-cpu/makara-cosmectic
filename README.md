...
- `netlify/functions/data.mts` — one serverless function that stores your products and sales in Netlify Database, shared across every device
- `db/` — the database schema and client (Drizzle ORM)
